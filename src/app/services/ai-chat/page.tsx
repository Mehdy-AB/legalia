...
export default function AiChatPage() {
    const howItWorks = [
        "يقوم النموذج الوسيط بتحليل طبيعة السؤال أو الطلب القانوني لتحديد السياق بدقة.",
        "يوجّه المعالجة إلى النموذج الأكثر ملاءمة من حيث التخصص والدقة (عام، قانوني، أو متخصص).",
        "يعمل كطبقة عزل وأمان بين المستخدم ونماذج الذكاء الاصطناعي الخارجية، حيث ينسق النتائج ضمن إجابة متماسكة ومتسقة."
    ]

    const coreFunctions = [
        { icon: Network, title: "التوجيه الذكي", description: "للنماذج الأفضل والأكثر دقة وكفاءة حسب نوع الطلب" },
        { icon: ShieldCheck, title: "ضمان الجودة", description: "تقليل الأخطاء الناتجة عن الاعتماد على نموذج واحد" },
        { icon: GitMerge, title: "التحقق المتقاطع", description: "تحسين جودة الإجابة من خلال مقارنة مخرجات متعددة" },
        { icon: Filter, title: "حماية الخصوصية", description: "تطبيق سياسات تصفية وإخفاء البيانات الحساسة تلقائيًا" }
    ]
    ...
    const benefits = [
        {
            ...
            description: "تكامل سلس بين أقوى نماذج الذكاء الاصطناعي العالمية والمحلية"
        },
        {
            icon: Zap,
            title: "تحسين الدقة والجودة",
            description: "نتائج أعلى موثوقية بفضل الاختيار الأمثل لنموذج المعالجة"
        },
        {
            icon: CheckCircle,
            title: "مراجعة وتحسين النتائج",
            description: "تدقيق آلي للإجابات قبل عرضها للمستخدم لضمان صحتها"
        },
        {
            icon: ShieldCheck,
            title: "أمان وخصوصية بياناتك",
            description: "تصفية البيانات الحساسة وعدم استخدامها في تدريب النماذج"
        },
        {
            icon: Bot,
            title: "تجربة استخدام احترافية",
            description: "واجهة موحدة تخفي تعقيدات التقنية لخلق تجربة سلسة"
        }
    ]
            ...
            <PageHero className="text-white" videoSrc="/images/ai-chat.mp4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-xl text-gray-200 leading-relaxed font-light max-w-3xl mx-auto">
                        توفر المنصة نظام دردشة قانونية متقدم قائم على بنية وسيطة خاصة يعمل على الربط المنهجي بين عدة نماذج ذكاء اصطناعي، مع توجيه كل استفسار أو مهمة إلى النموذج الأنسب.
                    </p>
                </div>
            </PageHero>
                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="bg-gradient-to-br from-amber-50 to-blue-50 rounded-2xl p-8 md:p-12 border border-amber-100 shadow-lg">
                            ...
                            <p className="text-lg text-gray-700 leading-loose">
                                يطبّق النظام سياسات صارمة لتصفية وإخفاء البيانات، مما يضمن استقلالية بياناتك وعدم استخدامها لأغراض التدريب.
                            </p>
                        </div>
                    </div>
                </div>
